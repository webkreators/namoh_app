...
@section("title") Edit Operator | {{ env('APP_NAME') }} @endsection
@section('content')
    <div class="page-header">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-circle-right2 mr-2"></i>
                    <span class="font-weight-bold mr-2">Edit Operator</span>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" class="jquery-validation-form custom-form" action="{{ route('operator.update', $operator->id) }}" id="create_customer" method="POST">
                    <div class="row">
                        <div class=col-md-6>
                            @csrf
                            @method('put')
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('company_name') ?? $operator->company_name }}" type="text" class="form-control" name="company_name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('operator_name') ?? $operator->operator_name }}" type="text" class="form-control" name="operator_name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('contact_number') ?? $operator->contact_number }}" type="text" class="form-control" name="contact_number"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('aadhaar_number') ?? $operator->aadhaar_number }}" type="text" class="form-control" name="aadhaar_number" placeholder="Aadhaar card Number" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('gstin_number') ?? $operator->gstin_number }}" type="text" class="form-control" name="gstin_number" placeholder="GSTIN number" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('dob') ?? $operator->dob != NULL ? \Carbon\Carbon::CreateFromFormat('Y-m-d', $operator->dob)->format('d/m/Y') : '' }}" type="text" class="form-control date-picker" name="dob" placeholder="DOB" />
                        ...
                        <div class ="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('address') ?? $operator->address }}" type="text" class="form-control" name="address"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input autocomplete='off' value="{{ old('secondary_number') ?? $operator->secondary_number }}" type="text" class="form-control" name="secondary_number" placeholder="Secondary number" >
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-primary">Update Operator<i class="icon-database-insert ml-1"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
